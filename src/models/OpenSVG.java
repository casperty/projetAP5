...
//	        		poly.getPoints().add(new Coord(Integer.parseInt(x1),Integer.parseInt(y1)));
	...
	public List<Coord> getPts(String s){
 	...
 	/**
 	 * Recupere la valeur a partir de la chaine donnee en parametre, cette valeur est entre deux mots donnÃ©s Ã©galement en parametre.
 	...
 	/**
 	 * Ceci permet de recuperer la valeur alpha qui est en pourcentage en valeur decimal (0 Ã  255)
 	 * @return alpha 
 	 */
 	public int getAlpha(){
